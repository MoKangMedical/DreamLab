  ...
  return (
    <div style={{ background: '#0a0a0c', minHeight: '100vh' }}>
      <div className="max-w-5xl mx-auto px-6 md:px-8 py-16 md:py-24">
        ...
        {/* Header */}
        <div className="mb-12">
          <Link href="/courses" className="text-sm mb-6 inline-block" style={{ color: '#d4a853' }}>
            ← 返回课程列表
          </Link>
          <div className="flex items-start gap-5 md:gap-7">
            ...
            <div>
              ...
              <h1 className="text-3xl md:text-5xl font-bold mb-4" style={{ fontFamily: "'Noto Serif SC', serif", color: '#f4f4f6', lineHeight: 1.16 }}>
                {course.title}
              </h1>
              <p className="text-base leading-8 max-w-3xl" style={{ color: '#85858e' }}>{course.description}</p>
            </div>
          </div>
        </div>
