...
export default function SpiritedPage() {
  ...
  return (
    <div className="min-h-screen relative overflow-hidden" style={{ background: 'linear-gradient(180deg, #060f18 0%, #0a1522 30%, #0f1e2e 60%, #0a1522 100%)' }}>
      {/* 星空背景 */}
      ...
      <div className={`relative z-10 max-w-5xl mx-auto px-4 pb-10 pt-10 md:pt-14 transition-all duration-1000 ${visible ? 'opacity-100' : 'opacity-0'}`}>
        ...
        <div className="text-center mb-8">
          <div className="inline-flex items-center gap-2 mb-4 text-xs tracking-[0.2em]"
            ...
            <span className="w-5 h-px" style={{ background: 'rgba(232,168,32,0.1)' }} />
            油屋の探索
            <span className="w-5 h-px" style={{ background: 'rgba(232,168,32,0.1)' }} />
          </div>
          ...
          <p className="text-sm mb-2" style={{ color: '#b8ad9a' }}>
            梦境探索 · 找回名字
          </p>
          <p className="text-sm max-w-md mx-auto leading-relaxed" style={{ color: '#7a7062' }}>
            油屋的每一层，都是一个心灵成长的阶段。
          ...
          <button onClick={() => setShowLore(!showLore)}
            ...
            <div className="flex items-center justify-between mb-2">
              <div className="flex items-center gap-3">
                ...
                <h2 className="font-bold text-lg" style={{ fontFamily: "'Noto Serif SC', serif", color: '#f5efe0' }}>
                  关于这座油屋
                </h2>
              </div>
              <span className="text-xs" style={{ color: '#5a5246' }}>{showLore ? '收起' : '展开'}</span>
            </div>
            ...
            {showLore && (
              <div className="mt-4 space-y-4">
                ...
                <blockquote className="border-l-2 pl-4 py-2 text-sm italic leading-relaxed"
                  style={{ borderColor: '#e8a82030', color: '#7a7062', lineHeight: 1.8 }}>
                  {LORE.inspiration}
                </blockquote>
        ...
        <div className="mt-16">
          <div className="flex items-center gap-3 mb-2">
            ...
            <span className="text-xs tracking-[0.2em] uppercase" style={{ color: 'rgba(232,168,32,0.5)' }}>楼层指南</span>
          </div>
            ...
            {FLOOR_DETAILS.map((floor, i) => (
              <div key={floor.floor} className="p-6 md:p-8 transition-all"
                ...
                <div className="flex items-start gap-5 mb-5">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-2 mb-1">
                      ...
                      <h3 className="text-xl font-bold" style={{ fontFamily: "'Noto Serif SC', serif", color: '#f5efe0' }}>
                        {floor.name}
                      </h3>
                    </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                  {/* 叙事层 */}
                  <div className="p-4" style={{ background: '#060f18', borderRadius: 2 }}>
                    <div className="text-xs mb-2 font-bold" style={{ color: floor.color }}>🎬 电影叙事</div>
                    <p className="text-sm leading-relaxed mb-2" style={{ color: '#b8ad9a', lineHeight: 1.7 }}>
                      {floor.symbolism}
                    </p>
                  ...
                  {/* 心理学层 */}
                  <div className="p-4" style={{ background: '#060f18', borderRadius: 2 }}>
                    <div className="text-xs mb-2 font-bold" style={{ color: '#e8a820' }}>🧠 心理学对应</div>
