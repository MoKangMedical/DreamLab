      ...
      <div className="max-w-5xl mx-auto px-4 md:px-6 pt-20 md:pt-28 pb-32">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-1 space-y-4">
            {/* 写作提示 */}
            <div style={{ background: '#0c0c0e', border: '1px solid #1c1c1f', borderRadius: 2, padding: 24 }}>
              <h3 className="text-sm font-bold mb-4" style={{ color: '#fafafa' }}>💡 写作引导</h3>
              <div className="space-y-3">
                {WRITING_PROMPTS.map((p, i) => (
                  <div key={i} className="cursor-pointer p-3 transition-all hover:bg-[#ffffff]/02"
                    ...
                    onMouseEnter={e => (e.currentTarget.style.borderLeftColor = '#e2b64f')}
          ...
          <div className="lg:col-span-2 space-y-5">
            <div style={{ background: '#0c0c0e', border: '1px solid #1c1c1f', borderRadius: 2, padding: 32 }}>
              {/* 标题 */}
              <div className="mb-5">
                ...
                <input
                  ...
                  style={{
                    ...
                    padding: '12px 0', color: '#fafafa', fontFamily: "'Noto Serif SC', serif",
                  ...
                  {emotionOptions.map(e => {
                    ...
                    return (
                      <button key={e} onClick={() => toggleEmotion(e)}
                        ...
                        style={{
                          background: active ? `${'#e2b64f'}18` : '#09090b',
                          border: `1px solid ${active ? '#e2b64f' : '#27272a'}`,
                          color: active ? '#e2b64f' : '#71717a',
                          borderRadius: 2,
                        }}>
                        {e}
                      </button>
              ...
              <button onClick={handleSubmit} disabled={submitting || !title.trim() || !content.trim()}
                ...
                style={{
                  padding: '16px', background: '#e2b64f', color: '#09090b',
            ...
            {/* 四视角预览 */}
            <div style={{ background: '#0c0c0e', border: '1px solid #1c1c1f', borderRadius: 2, padding: 24 }}>
              <p className="text-xs font-bold mb-3" style={{ color: '#fafafa' }}>🔬 AI 将从四个维度解读你的梦</p>
              <div className="grid grid-cols-2 gap-3">
                {[
                  { name: '弗洛伊德视角', desc: '潜意识欲望 · 压抑 · 童年', color: '#c47868' },
                  { name: '荣格视角', desc: '原型 · 集体无意识 · 补偿', color: '#9b8ab8' },
                  { name: '现代科学', desc: '记忆巩固 · 情绪调节 · REM', color: '#7eb8da' },
                  { name: '东方智慧', desc: '周公解梦 · 五行 · 庄周梦蝶', color: '#8aaf9d' },
                ].map(p => (
                  <div key={p.name} className="p-3" style={{ background: '#09090b', borderRadius: 2 }}>
